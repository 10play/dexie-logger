...
export type ReqForOperation<operation extends Operation> = Parameters<DBCoreTable[operation]>["0"];
export type ResForOperation<operation extends Operation> = Unpromise<ReturnType<DBCoreTable[operation]>>;
export type ResponseLoggingCallback<operation extends Operation> = (res: ResForOperation<operation>, props: LoggingResProps) => void;
